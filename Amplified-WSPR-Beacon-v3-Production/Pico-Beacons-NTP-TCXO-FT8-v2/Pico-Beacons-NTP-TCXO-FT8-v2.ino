...
long long frequency = 144175000LL * 100LL;  // 2m!!!
uint8_t tones[255];
int toneDelay;
int symbolCount;
int toneSpacing;
...
void setup() {
  ...
  pinMode(SW1, OUTPUT);
  digitalWrite(SW1, HIGH);  // Keep PTT engaged
  ...
  ret = si5351.init(SI5351_CRYSTAL_LOAD_8PF, 25000000, si5351CalibrationFactor);
  if (ret != true) {
    led_flash();
